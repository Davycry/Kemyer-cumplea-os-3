...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida:\n\nTe deseo un feliz cumpleaños mi niña. Este día es muy especial para ti y por eso.\n\nTe quiero recordar que siempre te amare mi princesita que siempre estare para ti.\n\nFeliz cumpleaños mi Kemyer <3.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Juancito";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Mi amor por ti es: <b>infinito <3</b><br>` +
      `Tu cumpleaños es el día: <b>8 de Septiembre reina</b>`;
